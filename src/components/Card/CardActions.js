...
const CardActions = ({ card, setCardToUpdate, openCardForm }) => {
  ...
  return (
    <div className='card-actions'>
      <button id='edit-card' onClick={editCard}><span className="material-icons-round">edit</span></button>
      <button id='delete-card' onClick={deleteCard}><span className="material-icons-round">delete</span></button>
    </div>
  );
};
